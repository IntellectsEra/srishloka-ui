      ...
      <header className="sticky top-0 z-40 border-b border-border bg-background/95 backdrop-blur">
        <div className="container-page flex h-16 items-center justify-between gap-6 lg:h-20">
          ...
          <Link to="/" className="flex flex-col items-center leading-none lg:items-start">
            ...
            <span className="eyebrow text-[9px] text-muted-foreground lg:text-[10px]">Flowers</span>
          </Link>
      ...
      {menuOpen && (
        <div className="fixed inset-0 z-50 bg-background lg:hidden">
          <div className="container-page flex h-16 items-center justify-between">
            ...
            <button className="-mr-2 p-2" onClick={() => setMenuOpen(false)} aria-label="Close menu">
              <X className="size-5" />
            </button>
          </div>
